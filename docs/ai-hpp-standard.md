...
1. Read input signal.
2. Check state, Constitutional Identity, and policy.
3. Verify Mission Continuity and Epistemic Integrity.
4. Pass through safety gates.
5. Use bridge if allowed.
6. Log action with reason.
